...
export default {
    data() {
        return {
            ...
            uploaddata: {
                uploaddata1: { name: 'thumbnailImg', Case_id: this.case_id },
                uploaddata2: { name: 'rawData', Case_id: this.case_id },
                uploaddata3: { name: 'miniData', Case_id: this.case_id },
                uploaddata4: { name: 'mrGlassData', Case_id: this.case_id },
                uploaddata5: { name: 'nakedEyeData', Case_id: this.case_id }
            }
        };
    },
    created() {
    ...
    methods: {
        ...
        beforeUpload() {
            this.$http.post(this.url, this.uploaddata, this.case_id).then(res => {
                console.log(res);
            });
        },
