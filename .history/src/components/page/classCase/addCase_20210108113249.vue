            ...
            this.$refs[formName].validate(valid => {
                if (valid) {
                    this.$http.post(this.com, this.ruleForm).then(res => {
                        ...
                        uploaddata1.case_id = this.case_id;
                        uploaddata2.case_id = this.case_id;
                        uploaddata3.case_id = this.case_id;
                        uploaddata4.case_id = this.case_id;
                        uploaddata5.case_id = this.case_id;
