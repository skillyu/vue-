            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                <div class="body_top">
                    ...
                    <el-form-item label="科室" prop="department">
                        <el-select v-model="ruleForm.department.value" placeholder="请选择科室">
                            <el-option v-for="item in ruleForm.department" :key="item.value" :label="item.label" :value="item.value">
                            </el-option>
                        </el-select>
                    </el-form-item>
