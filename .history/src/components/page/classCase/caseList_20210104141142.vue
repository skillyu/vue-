<template>
    <div>
        ...
        <div class="search">
            输入搜索：
            <div><el-input label="登录名称" v-model="input" placeholder="请输入内容"> </el-input></div>
            <div>
        ...
        <div>
            <el-table :data="tableData" border style="width: 100%">
                <el-table-column fixed prop="date" label="ID" width="120"> </el-table-column>
                ...
                <el-table-column fixed="right" label="审核状态" width="100">
                    <template slot-scope="scope">
                        ...
                        <el-button @click="handleClick(scope.row)" type="text" size="small">审核详情</el-button>
                    </template>
                </el-table-column>
