    ...
    <div>
        ...
        <div>
            <el-table :data="tableData" border style="width: 100%">
                <el-table-column prop="date" label="ID" width="140"> </el-table-column>
                ...
                <el-table-column prop="loading" label="下载数" width="140"> </el-table-column>
                <el-table-column prop="sale" label="销量" width="140"> </el-table-column>
                <el-table-column fixed="right" label="审核状态" width="100">
                    <template slot-scope="scope">
                        <el-button type="text" size="small" style="color:black">已审核</el-button>
                        <el-button @click="handleClick(scope.row)" type="text" size="small" style="margin-left:0">审核详情</el-button>
                    </template>
                </el-table-column>
...
export default {
    ...
    created() {
        this.com = 'http://192.168.1.118:8040/api/BMS/DM/ClassicCase/CasesList';
    },
    mounted() {
        Axios.post(this.com, {}).then(res => {
            console.log(res);
        });
    },
    methods: {
