<template>
    <div>
        ...
        <div class="search">
            输入搜索：
            <div>
                <el-input label="登录名称" v-model="keyword" @blur="queryData" @input="queryData" placeholder="案例名称/ID"> </el-input>
            </div>
            <div>
        ...
        <div>
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="thumbnail_address" label="案例图片" width="160">
                    <template slot-scope="scope">
                        <img :src="scope.row.thumbnail_address" alt="" style="width: 50px;height: 50px" />
                    </template>
                </el-table-column>
                ...
                <el-table-column prop="review_status" label="审核状态" width="100"></el-table-column>
...
export default {
    ...
    created() {
        ...
        //this.com1 = 'http://192.168.1.118:8060/api/BMS/DM/ClassicCase/DeleteCase';
        this.com = 'https://122.51.121.122/api/BMS/DM/ClassicCase/CasesList';
        this.com1 = 'https://122.51.121.122:8060/api/BMS/DM/ClassicCase/DeleteCase';
    },
    mounted() {
        this.$http
            .post(this.com, {
    ...
    methods: {
        ...
        deleteRow(index, rows) {
            console.log(this.tableData[index].case_id);
            this.id.Case_ID = this.tableData[index].case_id;
            this.$http.post(this.com1, this.id);
            rows.splice(index, 1);
        },
        editRow(index) {
            ...
            if (this.keyword === '' || this.keyword == null) {
                ...
                this.timer = setTimeout(() => {
                    ...
                    this.tableData.forEach(value => {
                        console.log(value);
                        if (value.case_id.indexOf(this.keyword) > -1 || value.case_name.indexOf(this.keyword) > -1) {
                            result.push(value);
                        }
                    });
