...
export default {
    ...
    created() {
        ...
        this.fileList_3[0].url = this.tableData.raw_data_address;
        this.fileList_4[0].name = this.tableData.case_name;
        this.fileList_4[0].url = this.tableData.raw_data_address;
        this.fileList_5[0].name = this.tableData.case_name;
        this.fileList_5[0].url = this.tableData.raw_data_address;
