<template>
    <div>
        ...
        <div class="choose">
            <el-checkbox v-model="tableData.user_power.PassWordUpdate" :change="changePower" label="修改密码" border></el-checkbox>
        ...
        <div class="btn">
            <el-row>
                <el-button type="primary" @click="changePower">确认修改</el-button>
            </el-row>
        </div>
    </div>
</template>
