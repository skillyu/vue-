            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column fixed="right" label="操作" width="280">
                    <template slot-scope="scope">
                        <el-button @click="detailClick(scope.$index, tableData)" type="text" size="small">查看详情</el-button>
                        <el-button @click="handleClick(scope.$index, tableData)" type="text" size="small">权限配置</el-button>
...
export default {
    ...
    methods: {
        ...
        detailClick(index) {
            this.$router.push({ path: '/detail', params: { tableData: this.tableData[index] } });
        },
