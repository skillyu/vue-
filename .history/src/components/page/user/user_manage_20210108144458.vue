<template>
    <div>
        ...
        <div class="search">
            <el-form :inline="true" :model="formInline" @blur="queryData" @input="queryData" class="demo-form-inline">
...
export default {
    ...
    created() {
        ...
        //this.com = 'https://localhost:5001/api/BMS/UM/ClassicCase/UserList';
    },
    mounted() {
        this.$http
            .post(this.com, {
